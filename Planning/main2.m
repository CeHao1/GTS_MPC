...
iter_all=6; % choose iteration
% iter_all=15;

params = car_parameters(1,'ttcoup_params.mat');
switch courseselect
    case 1
...
for iter=1:iter_all
    ...
    Vx=longtitudinal(kap,x_last,ds_ori,pos,params);
    % x_last(1,:)=Vx;
    % damping as well
    ...
    [xout,uout]=lateral(pos,edge,x_last,ds_ori,params);
