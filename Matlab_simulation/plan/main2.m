...
loadname='Track_50.mat';
[pos,edge,ds_ori]=initialize_centerline_Ugo(loadname);
name_prefix='Ugo-';
...
name=strcat(name_prefix,num2str(iter_all));
save(name,'sum_out','pos','edge','iter_all','kap','ds_ori')
msgbox('end')
